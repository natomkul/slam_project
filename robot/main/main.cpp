...
void app_main()
{
    ...
    static Leds leds{pwm}; // for now empty

    // motor 1 {10, 11}, encoders A - 1, B - 2
    // motor 2 {12, 13}, encoders A - 4, B - 5

    static Encoder encoderLeft(7, GPIO_NUM_1, GPIO_NUM_2, 0.05);
    static Motor motorLeft(GPIO_NUM_10, GPIO_NUM_11, encoderLeft, pwm); // Motor 1

    static Encoder encoderRight(7, GPIO_NUM_4, GPIO_NUM_5, 0.05);
